export default {
  ...
  user: {
    ...
    deactivateAccountInputPlaceholder: 'Enter "{keyword}" to proceed',
    deactivateAccountSuccess: 'Account deleted',
    deactivateAccountSuccessDescription: 'Your account has been deleted and the current login status on this device has been cleared.',
    ...
    trustedDevicesNoData: 'No trusted devices yet. After logging in on a new device and completing verification, the device will appear here.',
    trustedDevicesRemove: 'Remove',
    trustedDevicesLoginRequired: 'Please log in to manage trusted devices.',
    trustedDevicesUnknownDevice: 'Unknown device',
    trustedDevicesLoadFailed: 'Failed to load trusted devices',
    trustedDevicesRevokeFailed: 'Failed to revoke trusted devices',
    ...
    billingLoginPrompt: 'Please log in to view billing information',
    ...
    saveAnthropicConfigFailed: 'Failed to save Anthropic config',
  ...
  personal: {
    ...
    qizhi: 'Qizhi Bastion',
    rdpAsset: 'Remote Desktop',
    rdpDescription: 'RDP Remote Desktop Connection',
    pleaseInputRdpHost: 'Please input remote desktop host',
    rdpPort: 'Remote Desktop Port',
    rdpExtraArgs: 'Extra Arguments',
    rdpExtraArgsPlaceholder: 'e.g.: /w:2048 /h:2048',
    rdpConnectionStarted: 'RDP connection started. Please use the external remote desktop application to connect.',
  ...
  batchTask: {
    ...
    deleteRunConfirm: 'Confirm delete this run record?',
    taskName: 'Task Name',
    taskNamePlaceholder: 'Please enter task name',
    taskDescription: 'Task Description',
    taskDescriptionPlaceholder: 'Please enter task description (optional)',
    ...
    operationInstruction: 'Specific instruction',
    operationSkillPlaceholder: 'Pick an AI skill',
    operationInstructionPlaceholder: 'e.g. check disk usage and sort by utilization',
    kbPathPlaceholder: 'Click to pick from Knowledge Center',
    kbPickerTitle: 'Pick a KB script',
    kbEmpty: 'Knowledge Center is empty',
    ...
    cronHourly: 'Hourly',
    runNow: 'Run Now',
    activeRestrictionHint: 'Active terminal sessions change over time. Select them at run time instead.',
    runTask: 'Run Task',
    runConfirmHint: 'Review the terminals to run against (you can add or remove entries before confirming).',
    confirmExecute: 'Confirm & Run',
    executeFailed: 'Execution failed',
    noTerminalsForRun: 'Please select at least one terminal.',
    ...
    stepConfirm: 'Confirm',
    taskList: 'Task List',
    taskListDesc: 'View and manage all batch tasks',
    createTask: 'Create Task',
    createTaskDesc: 'Create a new batch task',
    runHistoryDesc: 'View all run history and reports',
    runHistory: 'Run History',
    clickToOpen: 'Click the button on the left to open task list or run history',
    startedAt: 'Start Time',
    noRunHistory: 'No execution history',
    back: 'Back',
    searchPlaceholder: 'Search...',
    run: 'Run',
    noResults: 'No results',
    selectItem: 'Please select a task or run record from the left',
    aiSummary: 'AI Summary',
    noTerminalResults: 'No terminal operations were executed for this task',
    noTerminalResultsFailed: 'All configured terminals failed to connect',
    checkMainLogHint: 'Please check the main process log for detailed error information',
    openTerminalFirst: 'Please open at least one connected terminal in the terminal area first',
    bastionAssetBlocked: 'Asset "{id}" is hosted behind a bastion host and requires a second login, so it cannot be executed in batch',
    ...
    columnConfig: 'Config',
    columnAction: 'Action',
    selectorTypeAsset: 'Asset',
    selectorTypeActive: 'Active Terminals',
    selectorTypeTemplate: 'Template Variables'
  }
}
