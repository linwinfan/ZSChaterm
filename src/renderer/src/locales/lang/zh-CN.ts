export default {
  ...
  user: {
    ...
    telemetry: '遥测',
    telemetryEnabled: '已开启',
    telemetryDisabled: '已关闭',
    telemetryDescription: '帮助 Chaterm 通过发送匿名使用数据和错误报告来改进产品。我们不会发送任何代码、请求内容或个人信息。详情请查看隐私政策。',
    telemetryDescriptionText: '帮助 Chaterm 通过发送匿名使用数据和错误报告来改进产品。我们不会发送任何代码、请求内容或个人信息。详情请查看隐私政策。',
    privacyPolicy: '隐私政策',
    enterprise: '企业用户',
    personal: '个人用户',
    name: '名称',
    ...
    deactivateAccount: '删除账户',
    deactivateAccountDescription: '如果您不再想使用此账户，可以在此删除。这也将清除此设备上的当前登录状态。',
    deactivateAccountConfirmTitle: '确认删除账户',
    deactivateAccountConfirmDescription: '删除账户是高危操作。若要继续，请在下方输入确认词。',
    deactivateAccountConfirmKeyword: '删除',
    deactivateAccountInputPlaceholder: '输入 "{keyword}" 以继续',
    deactivateAccountSuccess: '账户已删除',
    deactivateAccountSuccessDescription: '您的账户已被删除，当前设备的登录状态也已清除。',
    deactivateAccountFailed: '删除账户失败',
    deactivateAccountUserMissing: '无法确定当前用户账户。',
    privacy: '隐私',
    trustedDevices: '可信设备',
    trustedDevicesDescription: '这些设备已通过验证，可以在下次登录时跳过验证。移除后，该设备需要重新验证。',
    trustedDevicesCount: '{current} / {max} 设备',
    trustedDevicesMaxReached: '已达到最大可信设备数量。请先从列表中移除一个设备，再添加新设备。',
    trustedDevicesRemoveConfirm: '移除后，该设备需要在下次登录时重新验证。是否继续？',
    trustedDevicesCurrentDevice: '当前设备',
    trustedDevicesNoData: '尚无可信设备。在新设备上登录并完成验证后，该设备将显示在此处。',
    trustedDevicesRemove: '移除',
    trustedDevicesLoginRequired: '请登录以管理可信设备。',
    trustedDevicesUnknownDevice: '未知设备',
    trustedDevicesLoadFailed: '加载可信设备失败',
    trustedDevicesRevokeFailed: '撤销可信设备失败',
    anthropicApiKeyPh: '请输入API Key',
    anthropicApiKeyDescribe: '此密钥存储在本地，仅用于从此客户端发出API请求',
    anthropicBaseUrl: 'Anthropic API 基础地址',
    anthropicBaseUrlPh: '默认: https://api.anthropic.com',
    anthropicBaseUrlDescribe: '可选，留空则使用官方端点',
    kbSearchEnabled: '知识库搜索',
    kbSearchEnabledDescribe: '开始新对话时自动搜索知识库中的相关内容，并在回复中引用',
    experienceExtractionEnabled: '自动提取经验',
    experienceExtractionEnabledDescribe: '任务成功后，自动将可复用的经验提取到知识库',
    openAiBaseUrlDescribe: '自动添加 /v1 前缀。如需跳过，请在 URL 末尾添加 #',
    openAiBaseUrlPreview: '预览',
    openAiApiFormat: 'API 格式',
    billingLoginPrompt: '请登录以查看账单信息',
    billing: '账单使用量',
    subscription: '订阅类型',
    expires: '到期时间',
    ratio: '使用比例',
  ...
  personal: {
    ...
    qizhi: '齐治堡垒机',
    rdpAsset: '远程桌面',
    rdpDescription: 'RDP 远程桌面连接',
    pleaseInputRdpHost: '请输入远程桌面地址',
    rdpPort: '远程桌面端口',
    rdpExtraArgs: '额外参数',
    rdpExtraArgsPlaceholder: '例如: /w:2048 /h:2048',
    rdpConnectionStarted: 'RDP 连接已启动，请使用外部远程桌面应用程序进行连接',
    refreshAssets: '资产',
  ...
  batchTask: {
    ...
    deleteRunConfirm: '确认删除此执行记录？',
    taskName: '任务名称',
    taskNamePlaceholder: '请输入任务名称',
    taskDescription: '任务描述',
    taskDescriptionPlaceholder: '请输入任务描述（可选）',
    taskSummary: '任务概要',
    action: '操作',
    delete: '删除',
    triggerType: '触发方式',
    ...
    operationInstruction: '具体操作说明',
    operationSkillPlaceholder: '选择 AI 技能',
    operationInstructionPlaceholder: '例如：检查磁盘使用情况，把结果按使用率排序',
    kbPathPlaceholder: '点击从知识库选择',
    kbPickerTitle: '选择知识库脚本',
    kbEmpty: '知识库为空',
    addOperation: '添加操作',
    scriptContent: '脚本内容',
    ...
    cronHourly: '每小时',
    runNow: '立即执行',
    activeRestrictionHint: '已连接终端会在使用时不断变化，请在"执行任务"时再选择',
    runTask: '执行任务',
    runConfirmHint: '请确认要执行的终端（可增删后再执行）',
    confirmExecute: '确认执行',
    executeFailed: '执行失败',
    noTerminalsForRun: '请至少选择一个终端',
    taskNotFound: '任务未找到',
    cancelRun: '取消执行',
    viewReport: '查看报表',
    exportJson: '导出 JSON',
    ...
    stepConfirm: '确认执行',
    taskList: '任务列表',
    taskListDesc: '查看和管理所有批量任务',
    runHistoryDesc: '查看所有执行记录和报表',
    runHistory: '执行历史',
    clickToOpen: '点击左侧按钮打开任务列表或执行历史',
    createTask: '新建任务',
    createTaskDesc: '创建一个新的批量任务',
    startedAt: '开始时间',
    noRunHistory: '暂无执行记录',
    back: '返回',
    ...
    run: '执行',
    noResults: '无搜索结果',
    selectItem: '请从左侧选择一个任务或执行记录',
    aiSummary: 'AI总结',
    noTerminalResults: '该任务未执行任何终端操作',
    noTerminalResultsFailed: '所有配置的终端均未成功连接',
    checkMainLogHint: '请查看 main 进程日志获取详细错误信息',
    openTerminalFirst: '请先在终端区打开至少一个已连接终端',
    bastionAssetBlocked: '资产 "{id}" 属于堡垒机下的资产，需二次登录，无法批量执行',
    addTerminal: '添加终端',
    remove: '移除',
    columnType: '类型',
    columnAsset: '资产',
    ...
    columnConfig: '配置',
    columnAction: '操作',
    selectorTypeAsset: '资产',
    selectorTypeActive: '已连接终端',
    selectorTypeTemplate: '模板变量'
  }
}
